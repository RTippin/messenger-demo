        ...
        <nav id="RT_navbar" class="navbar fixed-bottom navbar-expand navbar-dark bg-dark">
            <div class="navbar-collapse collapse justify-content-center">
                <ul id="video_main_nav" class="navbar-nav">
                    ...
                    @endif
                    <li id="end_wb_btn" class="nav-item mr-2">
                        <button data-toggle="tooltip" title="Leave Call" data-placement="top" id="hang_up_btn" onclick="WebRTCManager.hangUp(false)" class="btn btn-danger pt-1 pb-0 px-2"><i class="fas fa-sign-out-alt fa-2x"></i></button>
                    </li>
                    <li class="nav-item mr-2 rtc_nav_opt rtc_nav_video NS">
                        <button onclick="WebRTCManager.changeState({action : 'disable_vid'})" data-toggle="tooltip" title="Disable video" data-placement="top" class="btn btn-success pt-1 pb-0 px-2 rtc_video_on rtc_nav_opt NS"><i class="fas fa-video fa-2x"></i></button>
                        <button onclick="WebRTCManager.changeState({action : 'enable_vid'})" data-toggle="tooltip" title="Enable video" data-placement="top" class="btn btn-danger pt-1 pb-0 px-2 rtc_video_off rtc_nav_opt NS"><i class="fas fa-video-slash fa-2x"></i></button>
                    </li>
