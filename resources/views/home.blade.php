...
<div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="lead">
                        ...
                        where you can find more information and install documentation. Calling in this demo is done using the default <code>Janus</code>
                        driver. We are running our own instance of <a href="https://janus.conf.meetecho.com/" target="_blank">Janus Media Server</a>,
                    ...
                    <p class="text-center h3">
                        ...
                        <br><br>
                        <a class="btn btn-lg btn-warning" href="{{route('messenger.portal')}}"><i class="fas fa-comments"></i> View</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header h3"><i class="fas fa-server"></i> <code>Messenger::getConfig()</code></div>
                <div class="card-body">
                    @php
